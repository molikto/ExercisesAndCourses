...
[numwords, batchsize] = size(input_batch);  % 3 * 100 -- we are live programming!!!!
[vocab_size, numhid1] = size(word_embedding_weights);  % vacab * 50
numhid2 = size(embed_to_hid_weights, 2); % 200 -- why the fuck you do not use global variables???

%% COMPUTE STATE OF WORD EMBEDDING LAYER.
% Look up the inputs word indices in the word_embedding_weights matrix.
% index into weights. so when training one world. other worlds is no useful
% at all!!!
