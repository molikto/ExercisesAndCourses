...
def Start( filename):
	...
	#example on Page 8 of lecture 15_CFL5
        ...
        production[0][0]=0; production[0][1]=2; production[0][2]=3  #S->BC
        production[1][0]=1; production[1][1]=2; production[1][2]=1  #A->BA
        production[2][0]=1; production[2][1]=0; production[2][2]=-1 #A->a
        production[3][0]=2; production[3][1]=3; production[3][2]=3  #B->CC
        production[4][0]=2; production[4][1]=1; production[4][2]=-1 #B->b
        production[5][0]=3; production[5][1]=1; production[5][2]=2 #C->a
        production[6][0]=3; production[6][1]=0; production[6][2]=-1 #C->b
